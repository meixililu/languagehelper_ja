 ...
 */
package com.messi.languagehelper_ja.views;
...
public class TabPageIndicator extends HorizontalScrollView implements PageIndicator {
    ...
    public void setCurrentItem(int item) {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            TextView temp = (TextView)child;
            temp.setTextColor(getContext().getResources().getColor(R.color.gray));
            final boolean isSelected = (i == item);
            child.setSelected(isSelected);
            if (isSelected) {
            	temp.setTextColor(getContext().getResources().getColor(R.color.top_blue));
                animateToTab(item);
            }
        }
    }
